#This file trains a NN and saves it to a checkpoint
#all files are created in home/workspace 
#(not in home/workspace/ImageClassifier)
#because ./ImageClassifier/train.py got me the error:
#"Permission denied"! 
